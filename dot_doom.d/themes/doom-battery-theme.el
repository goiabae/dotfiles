;; doom-battery-theme.el --- inspired by morhetz Gruvbox -*- lexical-binding: t; no-byte-compile: t; -*-
(require 'doom-themes)
...
;;
(defgroup doom-battery-theme nil
  "Options for doom-gruvbox."
  :group 'doom-themes)

(defcustom doom-battery-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'doom-battery-theme
  :type 'boolean)

(defcustom doom-battery-padded-modeline doom-themes-padded-modeline
  "If non-nil, adds a 4px padding to the mode-line. Can be an integer to
determine the exact padding."
  :group 'doom-battery-theme
  :type '(choice integer boolean))

(defcustom doom-battery-dark-variant nil
...
;;
(def-doom-theme doom-battery
  "Dark theme with pastel 'retro groove' colors."

  ;;| name      | gui     | 256     | 16          |
  ((bg
    (cond ((equal doom-battery-dark-variant "hard") '("#1d2021" "#1e1e1e" nil))   ; bg0_h
          ((equal doom-battery-dark-variant "soft") '("#32302f" "#323232" nil))   ; bg0_s
          (t                                        '("#252525" "#252525" nil)))) ; bg0
   (bg-alt
    (cond ((equal doom-battery-dark-variant "hard") '("#0d1011" "black" nil))     ; (self-defined)
          ((equal doom-battery-dark-variant "soft") '("#252525" "#252525" nil))   ; bg0
   ...
   (base2      '("#252525" "#252525" "brightblack")) ; bg0
   ...
   ;; Standardized official colours from battery
   (grey        '("#928374" "#909090" "brightblack"))   ; gray
   (red         '("#ff402b" "#ff402b" "red"))           ; bright-red
   (magenta     '("#cc241d" "#cc241d" "magenta"))       ; red
   (violet      '("#d38686" "#d3869b" "brightmagenta")) ; bright-purple
   (orange      '("#ff8022" "#ff8022" "orange"))        ; bright-orange
   (yellow      '("#fabd2f" "#fabd2f" "yellow"))        ; bright-yellow
   (dark-yellow '("#d79921" "#fabd2f" "yellow"))        ; yellow
   (teal        '("#8ec07c" "#8ec07c" "green"))         ; bright-aqua
   (green       '("#b5ba25" "#b5ba25" "green"))         ; bright-olive
   (dark-green  '("#98952a" "#98952a" "green"))         ; olive
   (blue        '("#46cc35" "#46cc35" "brightblue"))    ; bright-green
   (dark-blue   '("#29a019" "#29a019" "blue"))          ; green
   (cyan        '("#8ec07c" "#8ec07c" "brightcyan"))    ; bright-aqua
   (dark-cyan   '("#689e69" "#689e69" "cyan"))          ; aqua
   ...
   (selection      bg-alt2)
   (builtin        cyan)
   (comments       (if doom-battery-brighter-comments magenta grey))
   (doc-comments   (if doom-battery-brighter-comments (doom-lighten magenta 0.2) (doom-lighten fg-alt 0.25)))
   (constants      violet)
   (functions      green)
   (keywords       red)
   (methods        green)
   ...
   ;; custom categories
   (-modeline-pad
    (when doom-battery-padded-modeline
      (if (integerp doom-battery-padded-modeline)
          doom-battery-padded-modeline
        4)))
   (modeline-bg bg-alt2)
...
;;; doom-battery-theme.el ends here
