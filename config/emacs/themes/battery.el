...
(defmacro battery-deftheme (name description greys contrasts)
  `(autothemer-deftheme
    ...
    (
     ...
     (magit-blame-highlight (:extend t :foreground neutral0 :background neutral11))

     (magit-reflog-other       (:foreground lighter-cyan))
     (magit-reflog-remote      (:foreground lighter-cyan))
     (magit-reflog-cherry-pick (:foreground lighter-green))
     (magit-reflog-rebase      (:foreground light-purple))
     (magit-reflog-reset       (:foreground red))
     (magit-reflog-checkout    (:foreground neutral4))
     (magit-reflog-merge       (:foreground lighter-green))
     (magit-reflog-amend       (:foreground light-purple))
     (magit-reflog-commit      (:foreground lighter-green))

     (magit-bisect-bad  (:foreground dark-purple))
     ...
     (magit-sequence-part (:foreground dark-yellow))
     (magit-sequence-stop (:foreground green))
     (magit-sequence-pick (:inherit 'default))

     (magit-filename (:weight 'normal))

     (magit-cherry-equivalent (:foreground light-purple))
     (magit-cherry-unmatched  (:foreground lighter-cyan))

     (magit-signature-error       (:foreground neutral15))
     (magit-signature-revoked     (:foreground dark-purple))
     (magit-signature-expired-key (:inherit 'magit-signature-expired))
     (magit-signature-expired     (:foreground yellow))
     (magit-signature-untrusted   (:foreground lighter-cyan))
     (magit-signature-bad         (:weight 'bold :foreground red))
     (magit-signature-good        (:foreground lighter-green))
     ...
     (magit-tag    (:foreground dark-yellow))
     (magit-hash   (:foreground neutral9))
     (magit-dimmed (:foreground neutral8))
