...
*** modeline
#+begin_src elisp
(defface yeet/mode-line-buffer-name nil "Background color lightest yellow.")
  ...
  '((:eval (meow-indicator))
    (:eval
     (if (buffer-modified-p)
       (propertize " %b " 'face 'yeet/mode-line-buffer-name
...
*** J
On Void Linux this is pretty finnicky since the default name of the console is =jc= due to conflicts with other packages.
